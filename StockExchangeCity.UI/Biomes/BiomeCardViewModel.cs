...
public class BiomeCardViewModel : ContentView
{
	...
	public Color BiomeColor
	{
		...
		set => SetValue(BiomeColorProperty, value);
	}
	#endregion
	...
	BindableProperty.Create(
		nameof(CardColor), typeof(Color), typeof(BiomeCardView), Colors.DarkGray);
	...
	BindableProperty.Create(
		nameof(CardBorderColor), typeof(Color), typeof(BiomeCardView), Colors.WhiteSmoke);
	...
	public void AppendModel(Biome biome)
	{
		...
		if (Color.TryParse(BiomeColorHtml, out var color))
		{
			BiomeColor = color;
		}
